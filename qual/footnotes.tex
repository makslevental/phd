...
\anotecontent{sensorintegration}{For example pixel binning in CCDs and rolling-shutter blur for CMOS.}
\anotecontent{coma}{Off-axis point sources appearing distorted, appearing to have a tail (coma), due to variation in magnifcation over the image of the edge of the aperture (aperture stop).}
