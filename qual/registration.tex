\input{figures/sift/pyramid.tex}
...
%
For example for SIFT, where the descriptors are designed to be essentially invariant across images, Euclidean distance using a $k$-d tree\anote{kdtree} can be used to efficiently match keypoint descriptors.
%
