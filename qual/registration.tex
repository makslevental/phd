...
\end{align}
where \(\odot\) is Hadamard product\anote{hadamard}, \(|\mathcal{X}_1|\) is the magnitude of \(\mathcal{X}_1\), \(\mathcal{X}_1^*\) is the complex conjugate of \(\mathcal{X}_1\), and we've used the fact that \(|e^{iz}|=1\) for all \(z\).
%
