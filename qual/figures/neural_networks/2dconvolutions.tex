\begin{figure*}
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \begin{tikzpicture}[scale=\figscale,every node/.style={minimum size=1cm},on grid]
            ...
            \draw[fill=plum, opacity=0.4] (0,1) rectangle (1,2);
        ...
        \begin{tikzpicture}[scale=\figscale,every node/.style={minimum size=1cm},on grid]
            ...
            \begin{scope}[xshift=-5, yshift=5cm,
                ...
                \draw[fill=plum, opacity=0.4] (1,1) rectangle (2,2);
        ...
        \begin{tikzpicture}[scale=\figscale,every node/.style={minimum size=1cm},on grid]
            ...
            \begin{scope}[xshift=-5, yshift=5cm,
                ...
                \draw[fill=plum, opacity=0.4] (0,0) rectangle
                (1,1);
        ...
        \begin{tikzpicture}[scale=\figscale,every node/.style={minimum size=1cm},on grid]
            ...
            \begin{scope}[xshift=-5, yshift=5cm,
                ...
                (ETL) -- (TL)    (ETR) -- (TR);
                \pic{outputsquare=7/3/11/12};
                \draw[fill=plum, opacity=0.4] (1,0) rectangle
                (2,1);
