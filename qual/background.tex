...
%
The high number of transistors needed per pixel in CMOS arrays has only recently been manageable for semiconductor foundries.
%
...
%
With the maturation of micro-machining techniques (such as for MEMS\anote{mems} devices) over the last few years, two level microbolometers consisting of a thermo-sensitive component suspended above (and insulated from) silicon have been built (see figure~\ref{fig:microbolometer}).
%
