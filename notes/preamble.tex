...
\newtcbtheorem[number within=section]{definition}{Definition}{colback=purple!5,colframe=blue!100!,fonttitle=\bfseries}{def}
\newtcbtheorem[number within=section]{theorem}{Theorem}{colback=purple!5,colframe=blue!100!,fonttitle=\bfseries}{theo}
\newtcbtheorem[number within=section]{lemma}{Lemma}{colback=purple!5,colframe=blue!100!,fonttitle=\bfseries}{lem}
\newtcbtheorem[number within=section]{corollary}{Corollary}{colback=purple!5,colframe=blue!100!,fonttitle=\bfseries}{cor}
% \newtcbtheorem[number within=section]{example}{Example}{colback=purple!5,colframe=blue!100!,fonttitle=\bfseries}{exa}
\newtcbtheorem[number within=section]{proposition}{Proposition}{colback=purple!5,colframe=blue!100!,fonttitle=\bfseries}{prop}
