...
\numberwithin{propositionCounter}{section}

\theoremstyle{proposition}
\newmdtheoremenv[style=propositionSty]{proposition}[propositionCounter]{Proposition}
...
% \theoremstyle{definition}
% \newmdtheoremenv[style=proofSty]{prf}{Proof}
...
\theoremstyle{definition}
\newmdtheoremenv[style=definitionSty]{definition}[definitionCounter]{Definition}
